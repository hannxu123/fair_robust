...
def main(args):
    ...
    for now_epoch in range(1, maxepoch + 1):
        ...
        if now_epoch % 5 == 0:
            ...
            np.savetxt('Report_wrn_frlrm_' + args.model + '_' + str(args.seed) + '_' + str(args.rate1) + str(args.rate2) + '_' + str(
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--lim', type=float, default=0.3)
